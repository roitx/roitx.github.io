      ...
      notes.forEach(note => {
        ...
        row.innerHTML = `
          <div>
            ...
            <h4 style="margin:8px 0 0 0; color:#fff; font-size: 16px;">${note.chapter_name}</h4>
          </div>
          <button class="btn" style="padding:8px 16px; cursor:pointer;" onclick="openViewer('${note.file_path}')">📖 Read</button>
        `;
...
// PDF Viewer Redirect Helper (Naye tab me kholne ke liye)
