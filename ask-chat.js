// ask-chat.js — Smart Study Assistant with Groq AI, PDF Commands & Supabase Formulas
(function () {
  ...
  // ---- HELPER: GENERAL MENU FOR QUERIES ----
  function showGeneralSuggestionMenu(rawQuery) {
    ...
    // Exact page link from repository structure: {cls}-{subKey}-chapters.html
    const subjectPageUrl = `${cls}-${subKey}-chapters.html`;
    const chText = chNum ? ` (Chapter ${chNum})` : '';

    let html = `
      <div style="border: 1px solid #3b82f6; padding: 12px; border-radius: 10px; background: #1e293b;">
        <div style="font-size: 14px; font-weight: bold; color: #60a5fa; margin-bottom: 6px;">
          🤔 Kya aap <b>Class ${cls} ${subDisplay}${chText}</b> ke liye yeh chahte hain?
        </div>
        <div style="font-size: 12px; color: #cbd5e1; margin-bottom: 12px;">
          Kripya neeche दिए गए options में से चुनें:
        </div>

        <div style="display: flex; flex-direction: column; gap: 8px;">
          <!-- Option 1: Show Formulas -->
          <button onclick="runCommand('formula ${rawQuery}')" style="background: #d97706; color: #fff; border: none; padding: 8px 12px; border-radius: 6px; text-align: left; font-weight: bold; cursor: pointer;">
            📐 Show Formulas Only
          </button>

          <!-- Option 2: Show Notes PDF -->
          <button onclick="runCommand('open pdf ${cls} ${subKey} ch${chNum || 1}')" style="background: #0284c7; color: #fff; border: none; padding: 8px 12px; border-radius: 6px; text-align: left; font-weight: bold; cursor: pointer;">
            📖 Open Notes PDF Directly
          </button>

          <!-- Option 3: Go to Specific Subject Chapters Page -->
          <a href="${subjectPageUrl}" style="display: block; background: #059669; color: #fff; text-decoration: none; padding: 8px 12px; border-radius: 6px; text-align: center; font-weight: bold;">
            🌐 Go to Class ${cls} ${subDisplay} Chapters Page
          </a>
        </div>
      </div>
    `;
  ...
  async function fetchAndSuggestFormulas(queryText) {
    ...
    if (error) {
      console.error(error);
      addBotMsg('❌ Data load karne me error आया.');
      return;
    }
    ...
    if (formulaData && formulaData.length > 0) {
      ...
      html += `
        <div style="border: 1px dashed #06b6d4; padding: 12px; border-radius: 10px; background: rgba(6, 182, 212, 0.05); text-align: center;">
          <div style="font-size: 18px; font-weight: bold; margin-bottom: 4px;">✨ Formula Abhi Upload Nahi Hua Hai ✨</div>
...
3. Class 9 Chapter Pages:
- <a href="9-biology-chapters.html">Class 9 Biology</a>
- <a href="9-chemistry-chapters.html">Class 9 Chemistry</a>
- <a href="9-civics-chapters.html">Class 9 Civics</a>
- <a href="9-economics-chapters.html">Class 9 Economics</a>
- <a href="9-english-chapters.html">Class 9 English</a>
- <a href="9-geography-chapters.html">Class 9 Geography</a>
- <a href="9-hindi-chapters.html">Class 9 Hindi</a>
- <a href="9-history-chapters.html">Class 9 History</a>
- <a href="9-maths-chapters.html">Class 9 Maths</a>
- <a href="9-physics-chapters.html">Class 9 Physics</a>
- <a href="9-sanskrit-chapters.html">Class 9 Sanskrit</a>
- <a href="9-science-chapters.html">Class 9 Science Overview</a>
- <a href="9-sst-chapters.html">Class 9 SST Overview</a>

4. Class 10 Chapter Pages:
- <a href="10-biology-chapters.html">Class 10 Biology</a>
- <a href="10-chemistry-chapters.html">Class 10 Chemistry</a>
- <a href="10-civics-chapters.html">Class 10 Civics</a>
- <a href="10-economics-chapters.html">Class 10 Economics</a>
- <a href="10-english-chapters.html">Class 10 English</a>
- <a href="10-geography-chapters.html">Class 10 Geography</a>
- <a href="10-hindi-chapters.html">Class 10 Hindi</a>
- <a href="10-history-chapters.html">Class 10 History</a>
- <a href="10-maths-chapters.html">Class 10 Maths</a>
- <a href="10-physics-chapters.html">Class 10 Physics</a>
- <a href="10-sanskrit-chapters.html">Class 10 Sanskrit</a>

5. Class 11 Chapter Pages:
- <a href="11-accountancy-chapters.html">Class 11 Accountancy</a>
- <a href="11-biology-chapters.html">Class 11 Biology</a>
- <a href="11-chemistry-chapters.html">Class 11 Chemistry</a>
- <a href="11-civics-chapters.html">Class 11 Civics</a>
- <a href="11-computer-chapters.html">Class 11 Computer</a>
- <a href="11-economics-chapters.html">Class 11 Economics</a>
- <a href="11-english-chapters.html">Class 11 English</a>
- <a href="11-geography-chapters.html">Class 11 Geography</a>
- <a href="11-hindi-chapters.html">Class 11 Hindi</a>
- <a href="11-history-chapters.html">Class 11 History</a>
- <a href="11-maths-chapters.html">Class 11 Maths</a>
- <a href="11-physics-chapters.html">Class 11 Physics</a>

6. Class 12 Chapter Pages:
- <a href="12-accountancy-chapters.html">Class 12 Accountancy</a>
- <a href="12-biology-chapters.html">Class 12 Biology</a>
- <a href="12-chemistry-chapters.html">Class 12 Chemistry</a>
- <a href="12-civics-chapters.html">Class 12 Civics</a>
- <a href="12-computer-chapters.html">Class 12 Computer</a>
- <a href="12-economics-chapters.html">Class 12 Economics</a>
- <a href="12-english-chapters.html">Class 12 English</a>
- <a href="12-geography-chapters.html">Class 12 Geography</a>
- <a href="12-hindi-chapters.html">Class 12 Hindi</a>
- <a href="12-history-chapters.html">Class 12 History</a>
- <a href="12-maths-chapters.html">Class 12 Maths</a>
- <a href="12-physics-chapters.html">Class 12 Physics</a>

7. Study Tools, Viewers & Extras:
